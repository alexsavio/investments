...
pub fn process_income(
    ...
    for interest in &broker_statement.idle_cash_interest {
        ...
        match broker_jurisdiction {
            ...
            // The broker's jurisdiction, not the filer's: no broker files under Germany or Spain,
            // whose statements are generated by `tax_statement::{germany,spain}` before this code
            // is reached. The arms exist to keep the match exhaustive.
